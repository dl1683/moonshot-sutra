...
GCG coherence (every 10 steps): ~0.5 GB intermittent (running sum for variance decomposition)
...
- `gpu_mem_gb` — peak GPU memory at phase transitions and periodic log entries
...
| E2 unit tests | `code/test_eklavya_e2.py` (465 tests) |
