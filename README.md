...
| Unit tests (30 tests) | All passing | `code/test_eklavya.py` |
...
| Unit tests (387 E2 tests) | All passing | `code/test_eklavya_e2.py` |
...
All 638 tests run on CPU without any data, models, or GPU. They validate
