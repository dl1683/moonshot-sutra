...
| Unit tests (37 tests) | All passing | `code/test_eklavya.py` |
...
| Unit tests (397 E2 tests) | All passing | `code/test_eklavya_e2.py` |
...
All 655 tests run on CPU without any data, models, or GPU. They validate
