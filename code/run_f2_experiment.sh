...
echo "ARM 1 (KD-ON):"
echo "  python code/train_p1_twoteacher.py --run-name f2_kd_on --q1-queue code/q1_xtkd_queue.json --q2-queue code/q2_cka_queue.json --stop-at $TARGET_STEP"
echo ""
echo "ARM 2 (KD-OFF):"
echo "  python code/train_p1_twoteacher.py --teacher-free --run-name f2_kd_off --stop-at $TARGET_STEP"
echo ""
echo "After both complete, evaluate (with watcher tasks):"
echo "  python code/train_p1_twoteacher.py --det-eval results/checkpoints_f2_kd_on/rolling_latest.pt,results/checkpoints_f2_kd_off/rolling_latest.pt"
echo "  python code/lm_eval_wrapper.py --checkpoint results/checkpoints_f2_kd_on/rolling_latest.pt --tasks sciq,piqa,arc_easy,arc_challenge,hellaswag,winogrande,lambada_openai"
echo "  python code/lm_eval_wrapper.py --checkpoint results/checkpoints_f2_kd_off/rolling_latest.pt --tasks sciq,piqa,arc_easy,arc_challenge,hellaswag,winogrande,lambada_openai"
echo ""
